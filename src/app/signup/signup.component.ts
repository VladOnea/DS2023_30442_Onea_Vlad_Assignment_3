...
export class SignupComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.signupForm = this.formBuilder.group({
      ...
      phoneNumber:[null,[Validators.required,Validators.pattern(GlobalConstants.telephoneNumberRegex)]],
  ...
  handleSubmit(){
    ...
    this.userService.signup(userCredentials).subscribe((response:any)=>{
